  ...
  questions: [
    {
      ...
      options: [
        ...
        { id: 'c', text: 'Intellectually sharp', scores: { dark_cerebral: 2, quiet_intellectual: 2 } },
        { id: 'd', text: 'Strange and unforgettable', scores: { chaos: 3, atmospheric_explorer: 2 } },
      ],
    },
    {
      id: 'avoid',
      ...
      options: [
        { id: 'a', text: 'Too slow — I lose interest fast', scores: { momentum: 3 } },
        { id: 'b', text: 'Too predictable — I see every twist coming', scores: { chaos: 3, speculative_thinker: 1 } },
        { id: 'c', text: 'Flat characters — all plot, no depth', scores: { emotional_realist: 3, quiet_intellectual: 1 } },
        { id: 'd', text: 'Generic prose — writing that feels forgettable', scores: { quiet_intellectual: 3, dark_cerebral: 2, atmospheric_explorer: 2 } },
      ],
    },
    {
      id: 'vibe',
      text: 'Pick a reading vibe:',
      options: [
        { id: 'a', text: 'Heart-pounding, can\'t stop reading', scores: { momentum: 3, dark_cerebral: 1 } },
        { id: 'b', text: 'Dark, cerebral, emotionally intense', scores: { dark_cerebral: 3, quiet_intellectual: 1 } },
        { id: 'c', text: 'Atmospheric — mood is everything', scores: { atmospheric_explorer: 3, literary_escapist: 2 } },
        { id: 'd', text: 'Deeply human — real people, real pain', scores: { emotional_realist: 3, quiet_intellectual: 1 } },
      ],
    },
    {
      id: 'world',
      text: 'What kind of world do you want to read in?',
      options: [
        { id: 'a', text: 'A world so vivid I forget I\'m reading', scores: { literary_escapist: 3, atmospheric_explorer: 2 } },
        { id: 'b', text: 'The real world, but made stranger and more precise', scores: { dark_cerebral: 2, speculative_thinker: 2 } },
        { id: 'c', text: 'Everyday life — but painfully, beautifully real', scores: { emotional_realist: 2, quiet_intellectual: 2 } },
        { id: 'd', text: 'A future or alternate world that reframes everything', scores: { speculative_thinker: 3, chaos: 1 } },
      ],
    },
    {
      id: 'pace',
      text: 'How do you feel about pace?',
      options: [
        { id: 'a', text: 'Fast — I want to sprint through it', scores: { momentum: 3 } },
        { id: 'b', text: 'Slow and deliberate — I want to sit with it', scores: { quiet_intellectual: 3, atmospheric_explorer: 1 } },
        { id: 'c', text: 'Whatever serves the story', scores: { dark_cerebral: 1, emotional_realist: 1 } },
        { id: 'd', text: 'Unpredictable — I want it to surprise me', scores: { chaos: 3, speculative_thinker: 1 } },
      ],
    },
    {
      id: 'ending',
      text: 'What kind of ending do you want?',
      options: [
  ...
  questions: [
    {
      ...
      options: [
        { id: 'a', text: 'Disappeared into an immersive world for 6 hours', scores: { literary_escapist: 3, atmospheric_explorer: 1 } },
        { id: 'b', text: 'Finishing a thriller I started at midnight', scores: { momentum: 3, dark_cerebral: 1 } },
        { id: 'c', text: 'Sobbing over a character I loved too much', scores: { emotional_realist: 3, quiet_intellectual: 1 } },
        { id: 'd', text: 'Annotating a novel that challenged my worldview', scores: { quiet_intellectual: 3, speculative_thinker: 1 } },
      ],
    },
    {
      id: 'bp-q2',
      ...
      options: [
        { id: 'a', text: 'Speculative fiction, sci-fi, and concept-driven novels', scores: { speculative_thinker: 3, chaos: 1 } },
        { id: 'b', text: 'Thrillers, crime, and propulsive reads', scores: { momentum: 3, dark_cerebral: 1 } },
        { id: 'c', text: 'Atmospheric literary and immersive fiction', scores: { atmospheric_explorer: 2, literary_escapist: 2 } },
        { id: 'd', text: 'Dense literary fiction, classics, and essays', scores: { quiet_intellectual: 3, dark_cerebral: 1 } },
      ],
    },
    {
      id: 'bp-q3',
      ...
      options: [
        ...
        { id: 'b', text: 'The plot slows down after a strong opening', scores: { momentum: 3 } },
        { id: 'c', text: 'I don\'t care about the characters\' inner lives', scores: { emotional_realist: 3, quiet_intellectual: 1 } },
        { id: 'd', text: 'The writing feels shallow or unambitious', scores: { quiet_intellectual: 3, dark_cerebral: 2 } },
      ],
    },
    {
      id: 'bp-q4',
      ...
      options: [
        { id: 'a', text: 'It made me see the world completely differently', scores: { speculative_thinker: 3, dark_cerebral: 1 } },
        { id: 'b', text: 'There\'s a structural surprise I never saw coming', scores: { chaos: 3, momentum: 1 } },
        { id: 'c', text: 'I cried at least once and felt genuinely understood', scores: { emotional_realist: 3 } },
        { id: 'd', text: 'A mood from it lingered for days after I finished', scores: { atmospheric_explorer: 3, literary_escapist: 1 } },
      ],
    },
    {
      id: 'bp-q5',
      ...
      options: [
        { id: 'a', text: '"Always reading something dark and intense"', scores: { dark_cerebral: 3, quiet_intellectual: 1 } },
        { id: 'b', text: '"Can\'t believe you read that fast"', scores: { momentum: 3 } },
        { id: 'c', text: '"Cries at every book"', scores: { emotional_realist: 3 } },
        { id: 'd', text: '"Has opinions about everything they read"', scores: { quiet_intellectual: 2, speculative_thinker: 2 } },
      ],
    },
    {
      id: 'bp-q6',
      text: 'What do you want from a book\'s ending?',
      options: [
        { id: 'a', text: 'Emotionally devastating — I want to feel wrecked', scores: { emotional_realist: 2, dark_cerebral: 2 } },
        { id: 'b', text: 'A resolution I never saw coming', scores: { chaos: 3, momentum: 1 } },
        { id: 'c', text: 'Something that keeps me thinking for weeks', scores: { speculative_thinker: 2, quiet_intellectual: 2 } },
        { id: 'd', text: 'A lingering mood I can\'t shake', scores: { atmospheric_explorer: 3, literary_escapist: 1 } },
      ],
    },
  ],
  results: [
