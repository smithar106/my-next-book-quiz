            ...
            <tr><td align="center">
              <table width="100%" style="max-width:520px" cellpadding="0" cellspacing="0">
                ...
                <tr><td style="padding-top:32px;text-align:center">
                  <a href="https://apps.apple.com/app/apple-store/id6743767654" style="display:inline-block;background:#B89AFF;color:#120F1C;font-size:16px;font-weight:800;padding:16px 40px;border-radius:14px;text-decoration:none">
